...
/*! @name PORTE20 (number 13), J10[1]
  @{ */
#define BOARD_INITPINS_LDR_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_INITPINS_LDR_PIN 20U    /*!<@brief PORTE pin index: 20 */
                                      /* @} */

/*! @name PORTE22 (number 15), J10[5]
  @{ */
#define BOARD_INITPINS_LDR_2_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_INITPINS_LDR_2_PIN 22U    /*!<@brief PORTE pin index: 22 */
                                        /* @} */

/*! @name PORTE21 (number 14), J10[3]
  @{ */
#define BOARD_INITPINS_LED_FGPIO FGPIOE /*!<@brief FGPIO device name: FGPIOE */
#define BOARD_INITPINS_LED_GPIO GPIOE /*!<@brief GPIO device name: GPIOE */
#define BOARD_INITPINS_LED_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_INITPINS_LED_PIN 21U    /*!<@brief PORTE pin index: 21 */
                                      /* @} */

/*! @name PORTB3 (number 46), J10[8]/A3
  @{ */
#define BOARD_INITPINS_SERVOMOTOR_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_INITPINS_SERVOMOTOR_PIN 3U     /*!<@brief PORTB pin index: 3 */
                                             /* @} */
